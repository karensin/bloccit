...
describe("Post", () => {
  ...
  beforeEach((done) => {
//#1 declare two variables to represent our topic and post objects
    this.topic;
    this.post;
    this.user;
...
//#1 Create post and associate it with the topic we created in the 'beforeEach' call
       Post.create({
...
//#2 Check to make sure we save the post successfully
